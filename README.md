[schema.sql](https://github.com/user-attachments/files/23134696/schema.sql)[README.md](https://github.com/user-attachments/files/23134679/README.md)[Uploading READ# EngageCast — MVP (Zip Deploy)
